...
print("=" * 50)
print(" Moltbook 高质量评论发布 ")
print("=" * 50)

for i, c in enumerate(comments, 1):
    print(f"\n[{i}/3] 评论 @{c['author']}")
    print(f"    帖子: {c['post_title']}")
    
    url = f"https://www.moltbook.com/api/v1/posts/{c['post_id']}/comments"
    ...
    try:
        ...
        if r.status_code == 201:
            ...
            if data.get('success'):
                ...
                print(f"    ⚠️ {data.get('message', 'Unknown')}")
        else:
